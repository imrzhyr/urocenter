export const translations = {
  en: {
    ...
    "Waiting For Payment Verification": "Waiting for Payment Verification",
    "Our Support Team Is Processing Your Payment": "Our support team is processing your payment. This usually takes a few minutes.",
    "You Will Be Redirected Once Payment Is Confirmed": "You will be redirected automatically once your payment is confirmed",
    "Payment Verified Successfully": "Payment verified successfully! Welcome to UroCenter",
    "Our Support Team Is Available 24/7": "Our support team is available 24/7 to assist you",
    "Choose Your Preferred Payment Method": "Choose your preferred payment method",
  ...
  ar: {
    ...
    "Waiting For Payment Verification": "في انتظار التحقق من الدفع",
    "Our Support Team Is Processing Your Payment": "فريق الدعم لدينا يعالج دفعتك. عادة ما يستغرق ذلك بضع دقائق.",
    "You Will Be Redirected Once Payment Is Confirmed": "سيتم إعادة توجيهك تلقائياً بمجرد تأكيد الدفع",
    "Payment Verified Successfully": "تم التحقق من الدفع بنجاح! مرحباً بك في UroCenter",
    "Our Support Team Is Available 24/7": "فريق الدعم لدينا متاح على مدار الساعة طوال أيام الأسبوع لمساعدتك",
    "Choose Your Preferred Payment Method": "اختر طريقة الدفع المفضلة لديك",
    "Medical Consultation Fee": "رسوم الاستشارة الطبية",
  }
};
