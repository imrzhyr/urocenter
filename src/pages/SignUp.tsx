    ...
    <div className="min-h-screen flex flex-col bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full z-0 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-blue-100 to-blue-50 dark:from-blue-900 dark:to-blue-800">
          <div className="absolute inset-0 w-full h-full animate-wave">
            <svg className="absolute bottom-0 w-[200%] h-48" viewBox="0 0 2880 320" xmlns="http://www.w3.org/2000/svg">
              <path 
                fill="#0066CC" 
                fillOpacity="0.2" 
